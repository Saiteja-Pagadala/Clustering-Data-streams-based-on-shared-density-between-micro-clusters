...
<body>
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                           ...
                           <li><a href="${pageContext.request.contextPath}/process?query=viewReCluster" class="menu-top-active">Re-Cluster</a></li>
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Re-Cluster</h4>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <c:forEach items="${reclusterList }" var="data">
                                        <tr class="odd gradeX">
                                            <td>${data.xData}</td>
                                            <td>${data.yData}</td>
                                        </tr>
            ...
            <div class="col-md-6">
            		<div class="panel panel-info">
                        <div class="panel-heading">
                            Download Reclustered Stream (without Noise)
                        </div>
                        <div class="panel-body">
                             <a class="btn btn-primary btn-lg" style="padding: 5px 5px;font-size: 15px;" href="${pageContext.request.contextPath}/process?query=downloadRecluster">Download</a>
                        </div>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                             <img src="${pageContext.request.contextPath}/process?query=viewReclusterDataGraph" width="520px" height="400" border="0" usemap="#chart" />
                        </div>
