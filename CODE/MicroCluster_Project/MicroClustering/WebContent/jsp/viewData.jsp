...
<body>
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                           ...
                           <li><a href="${pageContext.request.contextPath}/process?query=viewData" class="menu-top-active">View Data</a></li>
                           <li><a href="${pageContext.request.contextPath}/process?query=viewCluster">Clusters</a></li>
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">View Data</h4>
